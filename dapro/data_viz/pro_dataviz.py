...
class DataViz:
    """
    Create 'DataViz' class for the sub-package 'pro_eda'. In this example, we implement one method for data exploration 'plot_histogram'
    """
